                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      formRegister(
                          key: controller.usernameEditProfileKey.value,
                      ...
                      formRegister(
                          key: controller.namaLengkapEditProfileKey.value,
                          textEditingController:
                      ...
                      formRegister(
                          ...
                          textEditingController: controller.noKtpEditProfileC,
                          hintText: 'Nomor KTP',
                      ...
                      formRegister(
                          ...
                          textEditingController: controller.noTelpEditProfileC,
                      ...
                      formRegister(
                          ...
                          textEditingController: controller.alamatEditProfileC,
                          hintText: 'Alamat',
                      ...
                      buttonWithIcon(
                        onTap: () {
                          ...
                          Future.delayed(const Duration(milliseconds: 120))
                              .then((value) {
                            if (controller
                                    .usernameEditProfileKey.value.currentState!
                                    .validate() &&
                                controller.namaLengkapEditProfileKey.value
                                    .currentState!
                                    .validate() &&
                                controller
                                    .noKtpEditProfileKey.value.currentState!
                                    .validate() &&
                                controller
                                    .noTelpEditProfileKey.value.currentState!
                                    .validate() &&
                                controller
                                    .alamatEditProfileKey.value.currentState!
                                    .validate()) {
                        ...
                        onLongPressEnd: (details) async {
                          ...
                          if (controller
                                  ...
                                  .validate() &&
                              controller
                                  .namaLengkapEditProfileKey.value.currentState!
                                  .validate() &&
                              controller.noKtpEditProfileKey.value.currentState!
                                  .validate() &&
                              controller
                                  .noTelpEditProfileKey.value.currentState!
                                  .validate() &&
